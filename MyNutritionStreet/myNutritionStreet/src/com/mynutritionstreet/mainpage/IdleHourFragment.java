...
public class IdleHourFragment extends Fragment {
public static final String ARG_SECTION_NUMBER = "section_daily";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.sample_idlehour_fragment, container, false);
		return view;
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		listview = (ListView) getActivity().findViewById(
				R.id.listView_sample_idle_fragment);
		getDataByServer();
	}

...
public class MyCollectionActivity extends Activity {
		...
		isDelete.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if (list1 != null) {
												...
												public void onClick(
													...
													for(int i = 0; i < list1.size(); i++){
														...
														if(DBPerform.deleteQuery(MyCollectionActivity.this, searchDemo, DBCreateWord.TB_NAME) == -1){
															Toast.makeText(MyCollectionActivity.this, "第"+(i+1)+"个商品删除失败!", Toast.LENGTH_SHORT).show();
															return;
														}
													}
													list1.clear();
												...
												public void onClick(
													...
													for (int i = in.size() - 1; i >= 0; i--) {
														if (adapter.goods
															...
															if(DBPerform.deleteQuery(MyCollectionActivity.this, searchDemo, DBCreateWord.TB_NAME) == -1){
																Toast.makeText(MyCollectionActivity.this, "删除第"+((int)in.get(i)+1)+"个商品失败!", Toast.LENGTH_SHORT).show();
															}else{
																Toast.makeText(MyCollectionActivity.this, "删除第"+((int)in.get(i)+1)+"个商品成功!", Toast.LENGTH_SHORT).show();
															}
															list1.remove((int) in
																	.get(i));
														}
					...
					Toast.makeText(MyCollectionActivity.this, "对不起，没有商品可以删除了!",
	...
	private void setListView() {
		...
		if (list1.size() > 0) {
			...
			Toast.makeText(MyCollectionActivity.this, "暂无任何商品被收藏!",
					Toast.LENGTH_SHORT).show();
		}

...
public class ClassifiedSearchServiceImpl {
	...
	public static List<Map<String, Object>> classifiedSearchByPage(
			int goodsTypeId, int page) {
		...
		data_goods = SelectInfoDao.selectGoodsInfo("goodsTypeId", goodsTypeId);

		for (int i = 0; i < data_goods.size(); i++) {
			if (Integer.parseInt(data_goods.get(i).get("isSale").toString()) == 0) {

...
public class ViewLatestServiceImpl {
	...
	public static List<Map<String, Object>> invertedSelectGoodsInfo(int page) {
		...
		data_goods = SelectInfoDao.invertedSelectGoodsInfo("goodsId");
